...
- fix buffer overflow when numParticles changes during animation
  - When layer props changed (e.g., viewport resize causing numParticles to change),
    pending setTimeout from requestStep() could fire after buffers were recreated
    with different sizes, causing copyBufferSubData to overflow
